...
| **Average RPS** | 83.3 req/sec | >= 80 req/sec | ✅ PASS |
| **Min Response Time** | 7.1 ms | N/A | info |
| **Max Response Time** | 494.7 ms | < 2000 ms | ✅ PASS |
| **Average Response Time** | 179.2 ms | < 300 ms | ✅ PASS |

## Test Parameters
- **Concurrent Users:** 20 threads
- **Request Target:** exactly 500 requests total
- **Endpoints Targeted:** `GET /health` and `POST /search`
- **Execution Timestamp:** 2026-06-23 21:21:03
