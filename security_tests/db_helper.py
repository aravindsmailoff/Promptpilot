...
class DBHelper:
    """Helper class to query the Railway PostgreSQL database for test verification."""
    ...
    def connect(self):
        ...
        try:
            # psycopg2 can parse connection strings directly, but doesn't support 'sslmode=no-verify'
            db_url = self.db_url
